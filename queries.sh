...
echo "$($PSQL "SELECT name FROM games LEFT JOIN teams ON teams.team_id IN(games.winner_id, games.opponent_id) WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name;")"
